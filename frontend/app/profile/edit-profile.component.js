    ...
    return {
        ...
        execute: function() {
            EditProfileComponent = (function () {
                function EditProfileComponent(_fb, _profileService) {
                ...
                EditProfileComponent.prototype.update = function (event, value) {
                    var _this = this;
                    ...
                    this._profileService.updateProfile(this._user).subscribe(function (response) {
                        //    console.log(response["status"]);
                        // this.signupResult=response;
                        _this.resultMessage = "profile updated successfully";
                ...
                EditProfileComponent.prototype.getAddress = function (place) {
