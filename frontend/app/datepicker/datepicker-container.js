System.register(['angular2/core', 'angular2/common', './moment-date-formatter'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, moment_date_formatter_1;
    var FORMAT_DAY, FORMAT_MONTH, FORMAT_YEAR, FORMAT_DAY_HEADER, FORMAT_DAY_TITLE, FORMAT_MONTH_TITLE, DATEPICKER_MODE, MIN_MODE, MAX_MODE, SHOW_WEEKS, ONLY_CURRENT_MONTH, STARTING_DAY, YEAR_RANGE, MIN_DATE, MAX_DATE, SHORTCUT_PROPAGATION, DAYS_IN_MONTH, KEYS, DatePickerInner;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
            ...
            function (moment_date_formatter_1_1) {
                moment_date_formatter_1 = moment_date_formatter_1_1;
            }],
        execute: function() {
            FORMAT_DAY = 'DD';
            FORMAT_MONTH = 'MMMM';
