System.register(['angular2/core', '../service/app.service', 'angular2/common', '../shared/control-message.component', '../shared/result-message.component', '../service/app.interface', 'angular2/router'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, app_service_1, common_1, control_message_component_1, result_message_component_1, app_interface_1, router_1;
        ...
        execute: function() {
            EditDeadLineComponent = (function () {
                ...
                EditDeadLineComponent.prototype.submit = function (event, value) {
                    var _this = this;
                    var _conference = new app_interface_1.ConferenceModel();
